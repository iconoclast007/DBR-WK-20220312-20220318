...
\marginpar{\scriptsize \centering \fcolorbox{black}{lime}{\textbf{AN EVEN WORSE ENDING}}\\ (Judges 21:1-25) \begin{compactenum}[I.][8]
...
\footnote{\textcolor[cmyk]{0.99998,1,0,0}{\hyperlink{TOC}{Return to end of Table of Contents.}}}\footnote{\href{https://audiobible.com/bible/judges_21.html}{\textcolor[cmyk]{0.99998,1,0,0}{Judges 21 Audio}}}\textcolor[cmyk]{0.99998,1,0,0}{Now the men of Israel had \fcolorbox{black}{lime}{sworn} in Mizpeh, saying, There shall not any of us give his daughter unto Benjamin to wife.}
[2] \textcolor[cmyk]{0.99998,1,0,0}{And the people came to the house of God, and abode there till even before God, and lifted up their \fcolorbox{black}{lime}{voices}, and wept sore;}
...
[5] \textcolor[cmyk]{0.99998,1,0,0}{And the children of Israel said, Who \emph{is} \emph{there} among all the tribes of Israel that came not up with the congregation unto the LORD? For they had made a great oath concerning him that came not up to the LORD to Mizpeh, saying, He shall surely be \fcolorbox{black}{lime}{put to death}.}
...
[10] \textcolor[cmyk]{0.99998,1,0,0}{And the congregation sent thither twelve thousand men of the \fcolorbox{black}{lime}{valiantest}, and commanded them, saying, Go and smite the inhabitants of Jabesh-gilead with the edge of the sword, with the women and the children.}
...
[12] \textcolor[cmyk]{0.99998,1,0,0}{And they found among the inhabitants of Jabesh-gilead four hundred young \fcolorbox{black}{lime}{virgins}, that had known no man by lying with any male: and they brought them unto the camp to Shiloh, which \emph{is} in the land of Canaan.}
...
[21] \textcolor[cmyk]{0.99998,1,0,0}{And see, and, behold, if the daughters of Shiloh come out to dance in dances, then come ye out of the \fcolorbox{black}{lime}{vineyards}, and catch you every man his wife of the daughters of Shiloh, and go to the land of Benjamin.}
...
[25] \textcolor[cmyk]{0.99998,1,0,0}{In those days \emph{there} \emph{was} \fcolorbox{black}{lime}{no king} in Israel: every man did \emph{that} \emph{which} \emph{was} right in his own eyes.}\footnote{\textbf{Proverb 14:12} - There is a way which seemeth right unto a man, but the end thereof \emph{are} the ways of death.}
